...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | 枫汐 ")[0];
}
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by 枫汐  %c 你正在访问Fomalhaut🥝の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 枫汐 ") ? title.substring(0, title.length - 14) : title;
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://tuchuang.voooe.cn/images/2023/03/06/105325311_p0.png);
    --darkmode-bg:url(https://lskypro.acozycotage.net/Fomalhaut/img/yuanshen1.webp);
    --mobileday-bg: url(https://tuchuang.voooe.cn/images/2023/03/10/QQ20230310142248.png);
